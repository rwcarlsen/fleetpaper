...
compared using combinations of either fleet-based or individually modeled reactors with
either monthly or quarterly (3-month) time steps.  The scenarios approximate a
transition from the current U.S. once-through light water reactor (LWR) fleet to a
