...
Traditionally, many fuel cycle simulators use a system dynamics approach
...
system (i.e.  the system's stocks and flows).  A modeled system is then solved
...
adjusted according to the calculated flow values.  The VISION simulator
\cite{jacobson_verifiable_2010} among others operates this way.  In
...
with the intent of modeling facilities individually with discrete flows
enabling the investigation of interesting real-world effects such as
competition, reactor cycle staggering, and individual reactor outages.  The
difference between these two modeling styles in terms of their affects on
output of fuel cycle simulators in general is currently unknown. This analysis
is designed to provide both quantitative and qualitative insight about how
fleet-based continuous flow models differ from individual facility discrete
flow models.
...
investigated together with fleet vs facility modeling.  Questions of interest
include:
...
reactor modeling together with variations in time step duration.
