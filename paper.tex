...
different due to inconsistency in modeling decisions such as reprocessing
...
domain.  Four scenarios were compared using combinations of fleet-based or
individual reactors with monthly or quarterly (3-month) time steps.  When
under supply-constraint pressure, the four cases exhibit noticably different
behavior.  Otherwise, they generally behaved very similarly.  Fleet-based
modeling is more efficient in supply-constrained environments at the expense
of losing insight on issues such as reactor refueling cycle staggering.
