...
\begin{table}[h]
    ...
    \begin{tabular}{ |r | c c | }
        ...
        \hline                       
        Lifetime (yr)         & 80 & 80 \\
        Cycle length (months) & 18 & 14 \\  %% why list this SFR cycle length if it's never used?
...
%% this tweak is a distraction.  Why not simply declare the SFR cycle length &
%% outage as 12/3 from the beginning.  Is this because the fuel recipes you
%% are using assume the other parameters and you don't want to sweep that
%% under the rug?
...
the same reactor to produce $[\frac{2.5}{3} \cdot 1 \text{mo} + 1 \cdot 2
